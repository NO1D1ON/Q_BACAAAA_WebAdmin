<x-guest-layout>
    ...
    <div class="mb-8 text-center">
        <a href="/" class="inline-block">
            <img src="{{ asset('assets/slide1.png') }}" alt="QBaca Logo" class="h-12 w-auto">
        </a>
    ...
    <div class="w-full max-w-md mx-auto space-y-6">
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div class="pt-4">
                <button type="submit"
                        class="w-full flex justify-center py-3 px-4 border border-transparent font-semibold rounded-md text-white bg-[#28738B] hover:bg-custom-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-custom-primary transition-colors duration-300">
                    {{ __('Log in') }}
                </button>
            </div>
        </form>
