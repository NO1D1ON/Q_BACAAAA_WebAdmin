        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- [PERBAIKAN] Tambahkan 'admin.' pada nama rute Kategori --}}
                    <x-nav-link :href="route('admin.categories.index')" :active="request()->routeIs('admin.categories.*')">
                        {{ __('Kategori') }}
                    </x-nav-link>

                    {{-- [PERBAIKAN] Tambahkan 'admin.' pada nama rute Buku --}}
                    ...
                    <x-nav-link :href="route('admin.topups.index')" :active="request()->routeIs('admin.topups.index')">
                        {{ __('Top-up') }}
                    </x-nav-link>
                </div>
            </div>
